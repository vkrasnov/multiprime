...
static int test_multi_prime_key(int nprimes, const char* pem,
                                unsigned pem_size, const unsigned char* enc,
                                unsigned enc_size)
{
...
int main(int argc, char *argv[])
{
 ...
 next:
    ...
    if (test_multi_prime_key(2, two_prime_key, sizeof(two_prime_key),
                             two_prime_encrypted_msg,
                             sizeof(two_prime_encrypted_msg)))
        err = 1;
    if (test_multi_prime_key(3, three_prime_key, sizeof(three_prime_key),
                             three_prime_encrypted_msg,
                             sizeof(three_prime_encrypted_msg)))
        err = 1;
    if (test_multi_prime_key(6, six_prime_key, sizeof(six_prime_key),
                             six_prime_encrypted_msg,
