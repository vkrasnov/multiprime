...
.align 32
.LAndMask_683:
.type .LAndMask_683,@object
.quad 0x1fffffff,0x1fffffff,0x1fffffff,0x1fffffff
.size .LAndMask_683,.-.LAndMask_683
.Lperm1:
.type .Lperm1,@object
...
.set b3, %r8 # const uint64_t *b3);
 ...
 .type LOAD_TRANSPOSE_683,@function
.globl LOAD_TRANSPOSE_683
.align 64
LOAD_TRANSPOSE_683:
...
.set T7, %ymm15
    ...
    vpand .LAndMask_683(%rip), X0, T0
    vpsrlq $29, X0, X0
    vpand .LAndMask_683(%rip), X0, T1
    vpsrlq $29, X0, X0
    vpsllq $6, X1, T2
    vpxor X0, T2, T2
    vpand .LAndMask_683(%rip), T2, T2
    vpsrlq $23, X1, X1
    vpand .LAndMask_683(%rip), X1, T3
    vpsrlq $29, X1, X1
    vpsllq $12, X2, T4
    vpxor X1, T4, T4
    vpand .LAndMask_683(%rip), T4, T4
    vpsrlq $17, X2, X2
    vpand .LAndMask_683(%rip), X2, T5
    vpsrlq $29, X2, X2
    vpsllq $18, X3, T6
    vpxor X2, T6, T6
    vpand .LAndMask_683(%rip), T6, T6
    vpsrlq $11, X3, X3
    vpand .LAndMask_683(%rip), X3, T7
    ...
    vpsllq $24, X4, T0
    vpxor X3, T0, T0
    vpand .LAndMask_683(%rip), T0, T0
    vpsrlq $5, X4, X4
    vpand .LAndMask_683(%rip), X4, T1
    vpsrlq $29, X4, X4
    vpand .LAndMask_683(%rip), X4, T2
    vpsrlq $29, X4, X4
    vpsllq $1, X5, T3
    vpxor X4, T3, T3
    vpand .LAndMask_683(%rip), T3, T3
    vpsrlq $28, X5, X5
    vpand .LAndMask_683(%rip), X5, T4
    vpsrlq $29, X5, X5
    vpsllq $7, X6, T5
    vpxor X5, T5, T5
    vpand .LAndMask_683(%rip), T5, T5
    vpsrlq $22, X6, X6
    vpand .LAndMask_683(%rip), X6, T6
    vpsrlq $29, X6, X6
    vpsllq $13, X7, T7
    vpxor X6, T7, T7
    vpand .LAndMask_683(%rip), T7, T7
    ...
    vmovdqa .LstoreMask(%rip), T0
    vpmaskmovq 32*2(b0), T0, X0
    vpmaskmovq 32*2(b1), T0, X1
    vpmaskmovq 32*2(b2), T0, X2
    vpmaskmovq 32*2(b3), T0, X3
    ...
    vpsrlq $16, X7, X7
    vpand .LAndMask_683(%rip), X7, T0
    vpsrlq $29, X7, X7
    vpsllq $19, X0, T1
    vpxor X7, T1, T1
    vpand .LAndMask_683(%rip), T1, T1
    vpsrlq $10, X0, X0
    vpand .LAndMask_683(%rip), X0, T2
    vpsrlq $29, X0, X0
    vpsllq $25, X1, T3
    vpxor X0, T3, T3
    vpand .LAndMask_683(%rip), T3, T3
    vpsrlq $4, X1, X1
    vpand .LAndMask_683(%rip), X1, T4
    vpsrlq $29, X1, X1
    vpand .LAndMask_683(%rip), X1, T5
    vpsrlq $29, X1, X1
    vpsllq $2, X2, T6
    vpxor X1, T6, T6
    vpand .LAndMask_683(%rip), T6, T6
    vpsrlq $27, X2, X2
    vpand .LAndMask_683(%rip), X2, T7
...
ret
.size LOAD_TRANSPOSE_683,.-LOAD_TRANSPOSE_683
################################################################################
################################################################################
#void TRANSPOSE_STORE_683(
...
.set o3, %r8 # const uint64_t *o3);
 ...
 .type TRANSPOSE_STORE_683,@function
.align 64
.globl TRANSPOSE_STORE_683
TRANSPOSE_STORE_683:
...
.set D9, %ymm13
    ...
    vmovdqa .LstoreMask(%rip), T0
    vpmaskmovq D0, T0, 32*2(o0)
    vpmaskmovq D1, T0, 32*2(o1)
    vpmaskmovq D2, T0, 32*2(o2)
    vpmaskmovq D3, T0, 32*2(o3)

    ret
.size TRANSPOSE_STORE_683,.-TRANSPOSE_STORE_683
################################################################################
################################################################################
#void SELECT_683(
...
1:
        vpcmpeqd (idx), %ymm13, %ymm14
        vpaddd .LvalOne(%rip), %ymm13, %ymm13

        vmovdqa 32*0(in_t), %ymm12
        vmovdqa 32*1(in_t), %ymm15
        vpand %ymm14, %ymm12, %ymm12
        vpand %ymm14, %ymm15, %ymm15
        vpxor %ymm12, %ymm0, %ymm0
        vpxor %ymm15, %ymm1, %ymm1
        vmovdqa 32*2(in_t), %ymm12
        vmovdqa 32*3(in_t), %ymm15
        vpand %ymm14, %ymm12, %ymm12
        vpand %ymm14, %ymm15, %ymm15
        vpxor %ymm12, %ymm2, %ymm2
        vpxor %ymm15, %ymm3, %ymm3
        vmovdqa 32*4(in_t), %ymm12
        vmovdqa 32*5(in_t), %ymm15
        vpand %ymm14, %ymm12, %ymm12
        vpand %ymm14, %ymm15, %ymm15
        vpxor %ymm12, %ymm4, %ymm4
        vpxor %ymm15, %ymm5, %ymm5
        vmovdqa 32*6(in_t), %ymm12
        vmovdqa 32*7(in_t), %ymm15
        vpand %ymm14, %ymm12, %ymm12
        vpand %ymm14, %ymm15, %ymm15
        vpxor %ymm12, %ymm6, %ymm6
        vpxor %ymm15, %ymm7, %ymm7
        vmovdqa 32*8(in_t), %ymm12
        vmovdqa 32*9(in_t), %ymm15
        vpand %ymm14, %ymm12, %ymm12
        vpand %ymm14, %ymm15, %ymm15
        vpxor %ymm12, %ymm8, %ymm8
        vpxor %ymm15, %ymm9, %ymm9
        vmovdqa 32*10(in_t), %ymm12
        vmovdqa 32*11(in_t), %ymm15
        vpand %ymm14, %ymm12, %ymm12
        vpand %ymm14, %ymm15, %ymm15
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm0, %ymm0
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm1, %ymm1
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm2, %ymm2
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm3, %ymm3
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm4, %ymm4
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm5, %ymm5
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm6, %ymm6
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm7, %ymm7
    ...
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm8, %ymm8
    vmovdqa %ymm13, 32*16(res)
    vmovdqa %ymm8, 32*17(res)

    vpermd %ymm9, %ymm14, %ymm13
    vpermd %ymm9, %ymm15, %ymm9
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm9, %ymm9
    vmovdqa %ymm13, 32*18(res)
    vmovdqa %ymm9, 32*19(res)

    vpermd %ymm10, %ymm14, %ymm13
    vpermd %ymm10, %ymm15, %ymm10
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm10, %ymm10
    vmovdqa %ymm13, 32*20(res)
    vmovdqa %ymm10, 32*21(res)

    vpermd %ymm11, %ymm14, %ymm13
    vpermd %ymm11, %ymm15, %ymm11
    vpand .LAndMask_683(%rip), %ymm13, %ymm13
    vpand .LAndMask_683(%rip), %ymm11, %ymm11
    vmovdqa %ymm13, 32*22(res)
    vmovdqa %ymm11, 32*23(res)

    ret

.size SELECT_683,.-SELECT_683
################################################################################
################################################################################
#void STORE_683(
...
.set idx, %rdx # int idx;
 ...
 .type STORE_683,@function
.align 64
.globl STORE_683
STORE_683:

    mov $24*4*4, %rax # Each operand is 18 redundant words, each word occupies 4 bytes, 4 operands
    mulq idx
    add %rax, table
...
.macro itr1 i,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11
    vmovdqu 32*\i(bpx4), B0
...
.macro missing0 i,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11
    vmovdqu 32*\i(bpx4), B0
...
# itr 0
    ...
    missing0 0,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11
    itr1 12,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11
    missing0 1,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0
    itr1 13,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0
    missing0 2,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1
    itr1 14,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1
    missing0 3,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2
    itr1 15,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2
    missing0 4,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3
    itr1 16,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3
    missing0 5,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4
    itr1 17,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4
    missing0 6,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5
    itr1 18,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5
    missing0 7,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6
    itr1 19,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6
    missing0 8,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7
    itr1 20,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7
    missing0 9,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8
    itr1 21,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8
    missing0 10,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9
    itr1 22,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9
    missing0 11,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10
    itr1 23,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10

    missing0 12,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11
    fix_store 0, ACC0, ACC1
    missing0 13,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0
    fix_store 1, ACC1, ACC2
    missing0 14,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1
    fix_store 2, ACC2, ACC3
    missing0 15,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2
    fix_store 3, ACC3, ACC4
    missing0 16,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3
    fix_store 4, ACC4, ACC5
    missing0 17,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4
    fix_store 5, ACC5, ACC6
    missing0 18,ACC6,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5
    fix_store 6, ACC6, ACC7
    missing0 19,ACC7,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6
    fix_store 7, ACC7, ACC8
    missing0 20,ACC8,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7
    fix_store 8, ACC8, ACC9
    missing0 21,ACC9,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8
    fix_store 9, ACC9, ACC10
    missing0 22,ACC10,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9
    fix_store 10, ACC10, ACC11
    missing0 23,ACC11,ACC0,ACC1,ACC2,ACC3,ACC4,ACC5,ACC6,ACC7,ACC8,ACC9,ACC10
    ...
    vpand .LAndMask_683(%rip), ACC10, T0
...
1:
    mov %rax, %rsp
    ret
.size AMM_WW_683_x4,.-AMM_WW_683_x4
################################################################################
################################################################################
#void AMS_WW_683_x4(
.set rpx4, %rdi # uint64_t *rpx4,
...
1:
    ...
    mov %rax, %rsp
    ret
.size AMS_WW_683_x4,.-AMS_WW_683_x4
